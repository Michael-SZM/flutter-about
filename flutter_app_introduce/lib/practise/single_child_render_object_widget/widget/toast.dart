...
class Toast {
  ...
  static String _msg;
  static Widget _cusWidget;
  static void toast(
      BuildContext context,
      String msg,
  // ignore: avoid_init_to_null
  {duration = 300,childWidget = null}
      ) async {
    assert(msg != null);
    _msg = msg;
    _cusWidget = childWidget;
            ...
            child: Container(
                ...
                child: Padding(
                  ...
                  child: AnimatedOpacity(
                    ...
                    child: _cusWidget == null?_buildToastWidget():_buildToastWidgetCus(_cusWidget),
                  ),
                )),
          ));
  ...
  //toast绘制留坑儿
  static _buildToastWidgetCus(cusWidget) {
    return Center(
      child: Card(
        color: Colors.black26,
        child: Padding(
